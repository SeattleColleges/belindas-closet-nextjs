// [NOTE] This component is included for future role editing UI
// It will be enabled once backend support is available.
...
//   return (
//     <Dialog sx={{ "& .MuiDialog-paper": { width: "50%", maxHeight: 435 } }} maxWidth="xs" open={open} {...other}>
//       <DialogTitle>User Role</DialogTitle>
//       <DialogContent dividers>
//         <RadioGroup ref={radioGroupRef} aria-label="role" name="role" value={value} onChange={handleChange}>
//           {options.map((option) => (
...
//         <EditIcon />
//       </IconButton>
//       <ConfirmationDialogRaw id="role-menu" keepMounted open={open} onClose={handleClose} value={value} />
//     </>
//   );
// }
