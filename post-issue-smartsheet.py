...
while True:
    ...
    smartsheet_response = requests.post(
        ...
        json={
            ...
            'cells': [
                {'columnId': 87440606842756, 'displayValue': 'title', 'value': title},
                {'columnId': 4591040234213252, 'displayValue': 'repo url', 'value': repo_url[45:]},
                {'columnId': 6842840047898500, 'displayValue': 'assignee', 'value': assignee},
                {'columnId': 1213340513685380, 'displayValue': 'index', 'value': index}
            ]
        }
    )
